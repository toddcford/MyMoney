  ...
  return (
    <div className={styles.nav}> 
      <div className={styles.sub_container}>
        <h3>Filter by: </h3>
        <button type="button"  onClick={()=> sortDate()} className="btn btn-success">Date</button>        
        <button type="button"  onClick={()=> sortValue()}className="btn btn-success">Amount</button>
        <button type="button"  onClick={()=> handleChartClick()}className="btn btn-success"> Category Breakdown</button>
      </div>
      {showPieChart ? 
