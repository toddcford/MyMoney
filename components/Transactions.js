  ...
  return (
    <div className={styles.nav}> 
      <div className={styles.sub_container}>
        <h3>Filter by: </h3>
        <button type="button" className={styles.button} onClick={()=> sortDate()} class="btn btn-success mr-2">Date</button>        
        <button type="button" className={styles.button} onClick={()=> sortValue()}class="btn btn-success mr-2">Amount</button>
        <button type="button" className={styles.button} onClick={()=> handleChartClick()}class="btn btn-success mr-2"> Category Breakdown</button>
      </div>
      {showPieChart ? 
